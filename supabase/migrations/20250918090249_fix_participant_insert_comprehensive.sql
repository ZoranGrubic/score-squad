-- Comprehensive fix for participant insertion policies
-- Allow both competition creators and users to add participants (with different rules)
...
-- 1. Competition creators can add any participants to their competitions
...
-- 2. Users can accept/decline invitations (update their own status)
